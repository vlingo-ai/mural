...
required='WEB_DOMAIN API_DOMAIN MODEL_GATEWAY_IMAGE LIVEKIT_WORKER_IMAGE LIVEKIT_URL LIVEKIT_API_KEY LIVEKIT_API_SECRET LIVEKIT_CONTROL_SECRET WORKER_OPENAI_API_KEY GATEWAY_OPENAI_API_KEY GATEWAY_API_KEY POSTGRES_PASSWORD HOSTED_VOICE_ACCOUNT_ALLOWLIST HOSTED_VOICE_LIFETIME_CAP_NANO HOSTED_HELPER_BUDGET_PER_MINUTE_NANO ACCOUNTS_HMAC_KEY ACCOUNTS_PROXY_TOKEN GOOGLE_CLIENT_ID GOOGLE_WEB_CLIENT_ID VITE_GOOGLE_CLIENT_ID AGE_RECIPIENT'
