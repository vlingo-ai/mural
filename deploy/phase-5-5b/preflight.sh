...
required='WEB_DOMAIN API_DOMAIN MURAL_API_IMAGE MODEL_GATEWAY_IMAGE LIVEKIT_WORKER_IMAGE LIVEKIT_URL LIVEKIT_API_KEY LIVEKIT_API_SECRET LIVEKIT_CONTROL_SECRET WORKER_OPENAI_API_KEY GATEWAY_OPENAI_API_KEY GATEWAY_API_KEY GATEWAY_OPENAI_MODEL_TRANSLATION_FAST GATEWAY_OPENAI_MODEL_ASSESSMENT_DEFAULT GATEWAY_OPENAI_MODEL_REASONING_DEFAULT GATEWAY_OPENAI_MODEL_SEARCH_DEFAULT POSTGRES_PASSWORD ACCOUNTS_HMAC_KEY ACCOUNTS_PROXY_TOKEN GOOGLE_WEB_CLIENT_ID VITE_GOOGLE_CLIENT_ID AGE_RECIPIENT'
